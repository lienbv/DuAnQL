	...
	<ul class="nav flex-column">
		...
		<li class="nav-item">
			<a class="nav-link active" aria-current="page" href="/QL_Dat_Ban_NH/Notification"> 
                ...
                THÔNG BÁO 
                <span class="position-absolute translate-middle badge rounded-pill bg-danger" style="top: 1 !important; left: 55% !important;"> 
                	 ${sl}
                	<span
		...
		<li class="nav-item">
			<a class="nav-link" href="/QL_Dat_Ban_NH/ViewMenuStaff"> 
		...
		<li class="nav-item">
			<a class="nav-link" href="/QL_Dat_Ban_NH/QuanLiThongTinBan"> 
		...
		<li class="nav-item">
			<a class="nav-link" href="/QL_Dat_Ban_NH/Logout"> 
